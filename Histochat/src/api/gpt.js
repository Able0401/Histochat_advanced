...
export const CallGPT = async ({
  ...
  const init_prompt2 = `${persona}의 목표는 나에게 ${learning_obejctive}에 대해 대화를 통해 알려주는 거야. 그리고 세부 학습 목표는 ${user_data.knowledge}에 들어있고 각각 목표 달성 여부가 표시되어 있어.모든 대화에서 목표들을 반드시 기억해야해. 목표들을 반드시 기억하되 말로 드러내지 말고 대화를 이어가면서 이 목표들을 달성하기 위해 대화해줘. ${user_data.knowledge}를 참고해서 얼마나 각각의 목표를 알고 있는지 파악하기 위해 질문들을 적극적으로 해줘`;
